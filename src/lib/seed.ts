import { initializeFirestoreData } from '@/lib/firestore';
 ...
 * Call this function once to populate Firestore collections
 * Usage: import and call seedFirestore() in your app initialization code
 */
export async function seedFirestore() {
  try {
    console.log('Seeding Firestore with initial data...');
    await initializeFirestoreData(seedCategories, seedProducts);
